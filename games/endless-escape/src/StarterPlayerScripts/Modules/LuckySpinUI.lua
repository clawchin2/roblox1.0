...
popupPrize.Size = UDim2.new(1, 0, 0, 50)
popupPrize.Position = UDim2.new(0, 0, 0, 70)
popupPrize.BackgroundTransparency = 1
popupPrize.Text = "???"
popupPrize.TextColor3 = Color3.new(1, 1, 1)
popupPrize.TextSize = 36
popupPrize.Font = Enum.Font.GothamBold
popupPrize.ZIndex = 201
popupPrize.Parent = prizePopup

local popupClose = Instance.new("TextButton")
popupClose.Size = UDim2.new(0, 100, 0, 35)
popupClose.Position = UDim2.new(0.5, -50, 1, -45)
popupClose.BackgroundColor3 = Color3.fromRGB(80, 80, 120)
popupClose.Text = "NICE!"
popupClose.TextColor3 = Color3.new(1, 1, 1)
popupClose.TextSize = 18
popupClose.Font = Enum.Font.GothamBold
popupClose.ZIndex = 201
popupClose.Parent = prizePopup
