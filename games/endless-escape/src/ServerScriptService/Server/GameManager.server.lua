...
local BackgroundManager = require(script.Parent:WaitForChild("BackgroundManager"))
...
local function setupPlayer(player: Player)
	...
	-- Setup background for player
	BackgroundManager:SetupPlayer(player)
end
...
Players.PlayerRemoving:Connect(function(player)
	...
	BackgroundManager:CleanupPlayer(player)
end)
