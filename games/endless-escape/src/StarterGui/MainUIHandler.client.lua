...
audioFrame.Size = UDim2.new(0, 140, 0, 80)
audioFrame.Position = UDim2.new(0, 10, 0, 20)
audioFrame.BackgroundColor3 = Color3.fromRGB(30, 30, 40)
audioFrame.BackgroundTransparency = 0.3
audioFrame.BorderSizePixel = 0
audioFrame.Parent = hudFrame

local audioCorner = Instance.new("UICorner")
audioCorner.CornerRadius = UDim.new(0, 8)
audioCorner.Parent = audioFrame

-- Mute button
local muteButton = Instance.new("TextButton")
muteButton.Name = "MuteButton"
muteButton.Size = UDim2.new(0, 50, 0, 50)
muteButton.Position = UDim2.new(0, 10, 0.5, -25)
muteButton.BackgroundColor3 = Color3.fromRGB(80, 200, 120)
muteButton.Text = "🔊"
muteButton.TextColor3 = Color3.fromRGB(255, 255, 255)
muteButton.TextScaled = true
muteButton.Font = Enum.Font.GothamBold
muteButton.Parent = audioFrame
...
volumeSliderBg.Name = "VolumeSliderBg"
volumeSliderBg.Size = UDim2.new(0, 60, 0, 10)
volumeSliderBg.Position = UDim2.new(0, 70, 0.5, -5)
volumeSliderBg.BackgroundColor3 = Color3.fromRGB(60, 60, 70)
volumeSliderBg.BorderSizePixel = 0
volumeSliderBg.Parent = audioFrame
...
volumeSliderFill.Name = "VolumeSliderFill"
volumeSliderFill.Size = UDim2.new(0.6, 0, 1, 0)
volumeSliderFill.BackgroundColor3 = Color3.fromRGB(100, 200, 255)
volumeSliderFill.BorderSizePixel = 0
volumeSliderFill.Parent = volumeSliderBg

local fillCorner = Instance.new("UICorner")
fillCorner.CornerRadius = UDim.new(0, 5)
fillCorner.Parent = volumeSliderFill

-- Volume label
local volumeLabel = Instance.new("TextLabel")
volumeLabel.Name = "VolumeLabel"
volumeLabel.Size = UDim2.new(0, 60, 0, 15)
volumeLabel.Position = UDim2.new(0, 70, 0, 8)
...
muteButton.MouseButton1Click:Connect(function()
	local isMuted = SoundManager:ToggleMute()
	if isMuted then
		muteButton.Text = "🔇"
		muteButton.BackgroundColor3 = Color3.fromRGB(255, 100, 100)
	else
		muteButton.Text = "🔊"
		muteButton.BackgroundColor3 = Color3.fromRGB(80, 200, 120)
	end
...
local function updateVolumeFromPosition(x: number)
	local sliderPos = volumeSliderBg.AbsolutePosition.X
	local sliderWidth = volumeSliderBg.AbsoluteSize.X
	local relativePos = math.clamp((x - sliderPos) / sliderWidth, 0, 1)
	
	volumeSliderFill.Size = UDim2.new(relativePos, 0, 1, 0)
	SoundManager:SetMasterVolume(relativePos)
end

volumeSliderBg.InputBegan:Connect(function(input)
	if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
		isDragging = true
		updateVolumeFromPosition(input.Position.X)
	end
end)

volumeSliderBg.InputEnded:Connect(function(input)
	if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
		isDragging = false
	end
end)
...
print("[UI] Main UI initialized with delayed monetization and audio controls")
